...
<form>
     <table width="auto" height="36" bgcolor="#CCCCCC">
      ...
      <td width="62"><input class="bordes" type="button" value="Agregar" onclick="Agregar();"/></td>
      <td width="68"><input class="bordes"type="button" value="Modificar" onclick="Modificar();"/></td>
